...
Stubs and "saplings" can be followed via my github RSS feed.

I guess medium modifications will be posted on my Mastodon? IDK yet.
...
- webmentions: I am not sure how to implement it. I think I want mainly the Mastodon support. I am interested in how bridging services to non webmention supporting sites are.

* Style

I like the Tufte design and it basicallys follow that, I am not using its style sheet at all just following some of its style.
